  ...
  return (
    <section className="mb-12 text-center px-4">
      ...
      <p className="max-w-2xl mx-auto text-gray-300 text-sm sm:text-base">
        I am a 4th-year IT student at Pamantasan ng Lungsod ng Valenzuela (PLV) 22 years old passionate about technology and related skills. Skilled in multimedia art, computer maintenance/troubleshooting, networking, and video editing.
      </p>
    </section>
  )
}
