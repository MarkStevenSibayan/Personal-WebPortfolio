      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <Link href="/resume#work-experience" className="block group">
            <Card className="relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 h-full overflow-hidden hover:border-blue-500/50 transition-all duration-300">
              <CardContent className="p-4 sm:p-5 lg:p-6 flex flex-col h-full">
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4 sm:mb-5">
                    <div className="p-2.5 sm:p-3 lg:p-4 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg sm:rounded-xl">
          ...
          <Link href="/resume#certifications" className="block group">
            <Card className="relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 h-full overflow-hidden hover:border-purple-500/50 transition-all duration-300">
              <CardContent className="p-4 sm:p-5 lg:p-6 flex flex-col h-full">
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4 sm:mb-5">
                    <div className="p-2.5 sm:p-3 lg:p-4 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg sm:rounded-xl">
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2 sm:mb-3 group-hover:text-purple-300 transition-colors">
                    Certifications
                  </h3>
