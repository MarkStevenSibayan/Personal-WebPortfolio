...
export default function Projects() {
  ...
  return (
    <section className="mb-12 px-4" id="projects">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8">
        {previewProjects.map((project) => (
          <Link href={`/projects#${project.id}`} key={project.id}>
            <div className="bg-card rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <div className="p-4">
                <h3 className="text-lg sm:text-xl font-semibold mb-2 text-accent">{project.title}</h3>
                <p className="text-foreground font-semibold mb-2">{project.role}</p>
      ...
      <div className="mt-16">
        <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center text-accent">
          3D Animation Showcase
        </h2>
        <div className="bg-card rounded-lg overflow-hidden shadow-lg p-6 border border-border">
          ...
          <div className="mt-4">
            <h3 className="text-xl font-semibold text-foreground mb-2">3D Animation: A Silent Departure</h3>
            ...
            <div className="mt-4">
              <span className="bg-secondary text-secondary-foreground px-3 py-1 rounded-full text-sm">Blender</span>
            </div>
          </div>
        </div>
      </div>
